...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://hamshi.auth0.com/authorize"+
                    "?audience=https://hamshi.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=8Ai3AnWwM6l3B3UVJxSFArnCGDDIxR9L"+
                    "&redirect_uri=http%3A%2f%2flocalhost%3A1104%2foauth%2faccess"+
                    "&state=123";
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        //OAuth Token URL
        String auth_url = "https://hamshi.auth0.com/oauth/token";
        
        //Prepare POST Request Body
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=8Ai3AnWwM6l3B3UVJxSFArnCGDDIxR9L"+
                            "&client_secret=mUr-OOWQ4URg9Ralcwd9TER-XQBSoD8ZGRF0NxjLm60T8eNhCUEl8gWgRq4lKVCq"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2f%2flocalhost%3A1104%2foauth%2faccess";
        String authReponse = "";
